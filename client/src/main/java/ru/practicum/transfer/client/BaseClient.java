...
public class BaseClient {
    ...
    protected <T> ResponseEntity<Object> get(String path, String start, String end,
    ...
    private <T> ResponseEntity<Object> get(String path, @Nullable Map<String, Object> parameters) {
